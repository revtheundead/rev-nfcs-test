...
#include "ResultViewShort.h";
namespace CppCLRWinformsProjektTestViewShort {
	...
	using namespace CppCLRWinformsProjektTestResultViewShort;
	using namespace WinformNFCSTestShort;
	using namespace WinformNFCSTestParticipant;


	public ref class TestViewShort : public System::Windows::Forms::Form
	{
	public:
		TestViewShort(void)
		{
...
#pragma region Windows Form Designer generated code
		void InitializeComponent(void)
		{
			...
			this->btnNext->Click += gcnew System::EventHandler(this, &TestViewShort::btnNext_Click);
			// 
			// btnBack
			// 
			...
			this->btnBack->Click += gcnew System::EventHandler(this, &TestViewShort::btnBack_Click);
			// 
			// btnCancel
			// 
			...
			this->btnCancel->Click += gcnew System::EventHandler(this, &TestViewShort::btnCancel_Click);
			// 
			// TestViewShort
			// 
			...
			this->Name = L"TestViewShort";
			this->Text = L"NFCS Short Test";
